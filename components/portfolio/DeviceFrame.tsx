...
export function DeviceFrame({
  ...
  return (
    <div className="relative mx-auto flex shrink-0 select-none justify-center">
      <div
        className="portfolio-device-shell relative rounded-[2.6rem] bg-gradient-to-b from-zinc-800 via-zinc-900 to-zinc-950 p-[10px] shadow-[0_28px_80px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] ring-1 ring-white/10"
      >
